        ...
        <div class="header-element">
            ...
            <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                <?php if($_SESSION['logged']){ ?>
                    ...
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex" href="?p=my-campaigns">
                            <i class="bi bi-newspaper me-2"></i> Minhas Campanhas
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item dropdown-hover d-flex" data-bs-toggle="modal" href="#modal" onclick="body_modal('logout')">
                            <i class="bi bi-arrow-left-circle me-2"></i> Encerrar Sessão
                        </a>
                    </li>
                <?php }else{ ?>
                    <li>
